...
class GNPy_Simulator:
    ...
    def simulate(self, topology_file, eqpt_file):
        ...
        for r in range(self._rounds):
            ...
            self.fixed_paths = {
                ('trx_dA_v2', 'trx_dC_v1'): [[('trx_dA_v2', 'dA_v2'), ('dA_v2', 'dB_v3'), ('dB_v3', 'dB_v4'), ('dB_v4', 'dB_v2'), ('dB_v2', 'dB_v5'), ('dB_v5', 'dB_v2'), ('dB_v1', 'dA_v1'), ('dA_v1', 'dC_v1'), ('dC_v1', 'trx_dC_v1')]],                                                                                                                                             # red
                ('trx_dD_v2', 'trx_dC_v1'): [[('trx_dD_v2', 'dD_v2'), ('dD_v2', 'dC_v2'), ('dC_v2', 'dC_v4'), ('dC_v4', 'dC_v3'), ('dC_v3', 'dA_v2'), ('dA_v2', 'dA_v4'), ('dA_v4', 'dA_v3'), ('dA_v3', 'dA_v1'), ('dA_v1', 'dC_v1'), ('dC_v1', 'trx_dC_v1')]],                                                                                                                         # blue
                ('trx_dC_v3', 'trx_dC_v1'): [[('trx_dC_v3', 'dC_v3'), ('dC_v3', 'dA_v2'), ('dA_v2', 'dA_v4'), ('dA_v4', 'dA_v3'), ('dA_v3', 'dA_v1'), ('dA_v1', 'dB_v1'), ('dB_v1', 'dB_v5'), ('dB_v5', 'dB_v2'), ('dB_v2', 'dB_v4'), ('dB_v4', 'dD_v1'), ('dD_v1', 'dD_v3'), ('dD_v3', 'dD_v2'), ('dD_v2', 'dC_v2'), ('dC_v2', 'dC_v5'), ('dC_v5', 'dC_v1'), ('dC_v1', 'trx_dC_v1')]], # green
                ('trx_dA_v1', 'trx_dC_v1'): [[('trx_dA_v1', 'dA_v1'), ('dA_v1', 'dA_v3'), ('dA_v3', 'dA_v4'), ('dA_v4', 'dA_v2'), ('dA_v2', 'dB_v3'), ('dB_v3', 'dB_v4'), ('dB_v4', 'dB_v2'), ('dB_v2', 'dD_v1'), ('dD_v1', 'dD_v3'), ('dD_v3', 'dD_v2'), ('dD_v2', 'dC_v2'), ('dC_v2', 'dC_v4'), ('dC_v4', 'dC_v3'), ('dC_v3', 'dC_v5'), ('dC_v5', 'dC_v1'), ('dC_v1', 'trx_dC_v1')]]  # pink
            }

            # for the remaining available service slots, we create new ones
            for n in range(self._num_req - len(active_cnxns)):

                (src, des) = list(self.fixed_paths.keys())[n%4]    # get from hard coded values
                # print(f"{n%4}  {list(self.fixed_paths.keys())[n%4]}")
