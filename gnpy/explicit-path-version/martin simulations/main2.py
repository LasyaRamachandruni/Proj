from service_generator2 import GNPy_Simulator
...
if __name__ == "__main__":
	...
	rounds = 10
	num_req = 4		# 4 hard coded monitoring trails

	s = GNPy_Simulator(topology_file, eqpt_file, rounds=rounds, num_req=num_req, max_ht=10, broken_fibers=broken_fibers,
		loss_coef=0.8)
