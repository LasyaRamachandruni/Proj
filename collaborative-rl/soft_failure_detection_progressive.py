...
from keras.metrics import AUC, BinaryAccuracy, Metric, Precision, Recall
from keras.callbacks import EarlyStopping
from keras.optimizers import Adam
from DQN_runner import F1Score
...
if __name__ == "__main__":
    ...
    folder_path = f'/opt/localization toy problem (martin)/version 2/soft failure/44 paths progressive/test2'
    ...
    all_files = []
    for f in folders2:
        f = f"{f}"    # update folder to include path
    ...
    # saving model
    model.save('/opt/collaborative-rl/saved_model.keras')
